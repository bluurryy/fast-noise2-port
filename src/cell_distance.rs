use crate::{
    cell::{
        CellIndex, DistanceFn, DistanceReturnType, JITTER_2D, JITTER_3D, JITTER_4D,
        MAX_DISTANCE_COUNT, calc_distance2, calc_distance3, calc_distance4,
    },
    hash_primes2_hb, hash_primes3_hb, hash_primes4_hb, inv_sqrt, max, min, mul_add, primes,
    reciprocal,
};
...
pub fn gen2([x, y]: [f32; 2], seed: i32, settings: CellDistance) -> f32 {
...
pub fn gen3([x, y, z]: [f32; 3], seed: i32, settings: CellDistance) -> f32 {
...
pub fn gen4([x, y, z, w]: [f32; 4], seed: i32, settings: CellDistance) -> f32 {
        ...
        for _yi in 0..3 {
            ...
            for _zi in 0..3 {
                ...
                for _wi in 0..3 {
                    ...
                    loop {
                        distance[i] =
                            max(min(distance[i], new_distance), distance[i.wrapping_sub(1)]);
